...
#define PR_BUILD_OPTS " '--host=arm-linux' '--target=arm-linux' '--build=i686-pc-linux' 'CFLAGS=-I/home/mt7623/userapps/nasapp/root/include -DUSE_IPTIME_WELCOME -DHAVE_LC_MESSAGES -DEFM_ROUTER_PATCH -DEFM_MT7621_PATCH -D_REENTRANT -mcpu=cortex-a7 -O2 -fomit-frame-pointer -pipe -Os' 'LDFLAGS=-L/home/mt7623/userapps/nasapp/root/lib -liconv' '--enable-autoshadow' '--disable-cap' '--disable-auth-file' '--disable-auth-pam' '--enable-nls' '--disable-strip' '--with-modules=mod_codeconv:mod_df' '--prefix=/home/mt7623/userapps/nasapp/root' 'build_alias=i686-pc-linux' 'host_alias=arm-linux' 'target_alias=arm-linux' 'CC=/opt/buildroot-gcc483_arm/usr/bin/arm-linux-gcc'"

/* Define to be the build CFLAGS.  */
#define PR_BUILD_CFLAGS "-I/home/mt7623/userapps/nasapp/root/include -DUSE_IPTIME_WELCOME -DHAVE_LC_MESSAGES -DEFM_ROUTER_PATCH -DEFM_MT7621_PATCH -D_REENTRANT -mcpu=cortex-a7 -O2 -fomit-frame-pointer -pipe -Os -Wall"

/* Define to be the build LDLAGS.  */
#define PR_BUILD_LDFLAGS "-L$(top_srcdir)/lib -L/home/mt7623/userapps/nasapp/root/lib -liconv "
...
#define PR_CONFIG_DIR "/home/mt7623/userapps/nasapp/root/etc"
#endif /* PR_CONFIG_DIR */

#ifndef PR_INCLUDE_DIR
#define PR_INCLUDE_DIR "/home/mt7623/userapps/nasapp/root/include"
#endif /* PR_INCLUDE_DIR */

#ifndef PR_LIBEXEC_DIR
#define PR_LIBEXEC_DIR "/home/mt7623/userapps/nasapp/root/libexec"
#endif /* PR_LIBEXEC_DIR */

#ifndef PR_LOCALE_DIR
#define PR_LOCALE_DIR "/home/mt7623/userapps/nasapp/root/share/locale"
#endif /* PR_LOCALE_DIR */

#ifndef PR_RUN_DIR
#define PR_RUN_DIR "/home/mt7623/userapps/nasapp/root/var"
#endif /* PR_RUN_DIR */

#ifndef PR_CONFIG_FILE_PATH
#define PR_CONFIG_FILE_PATH "/home/mt7623/userapps/nasapp/root/etc/proftpd.conf"
#endif /* PR_CONFIG_FILE_PATH */

#ifndef PR_PID_FILE_PATH
#define PR_PID_FILE_PATH "/home/mt7623/userapps/nasapp/root/var/proftpd.pid"
